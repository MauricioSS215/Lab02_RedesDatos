...
def main():
    if len(sys.argv) != 4:
        print("Uso: python client3.py <server_host> <server_port> <filename>")
        sys.exit(1)
    ...
    print(f"CLIENTE 3 - Conectando a {server_host}:{server_port}")
    ...
    try:
        ...
        print(f"Error en el cliente 3: {e}")
    finally:
        client.close()
        print("Conexion cerrada - Cliente 3 finalizado")
